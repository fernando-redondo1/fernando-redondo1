...
[cite_start]La tecnología me ha interesado desde siempre, y la seguridad informática es lo que más me mueve: cómo se protegen los sistemas, cómo fallan y cómo eso afecta al día a día de una empresa[cite: 43]. [cite_start]Mi objetivo es aportar actitud y base técnica sólida en el análisis y defensa de entornos digitales[cite: 44].
...
### 🏆 Certificaciones & Laboratorios
- [cite_start]**Cisco Networking Academy:** Introduction to Cybersecurity[cite: 27, 28].
- [cite_start]**AWS:** Cloud Quest: Cloud Practitioner[cite: 29, 30].
- [cite_start]**HackTheBox:** [@Fernandoredondol](https://app.hackthebox.com/users/37)[cite: 36, 37].
- [cite_start]**TryHackMe:** [ferredit26](https://tryhackme.com/p/ferredit26)[cite: 38, 39].
